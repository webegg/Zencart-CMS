<?php 
	...
	if(isset($_POST['submit'])){ 
		...
		if ($id == '') { 
			$db->query("INSERT INTO property_buildings (building_name) VALUES ('$building_name')");
			$update_message = '<li class="green"><span class="ico"></span><strong class="system_title">Property type successfully added!</strong></li>';
		} else {
		$db->query("UPDATE property_buildings SET building_name='$building_name' WHERE building_id='$building_id'");
		$update_message = '<li class="green"><span class="ico"></span><strong class="system_title">Property type successfully updated!</strong></li>';
		}
	}
	
	$query = "SELECT * FROM property_buildings WHERE building_id='$id'";
	$row = $db->getRow ( $query );
                ...
                <div class="sct_right">
                    <div class="sct_left">
                        <div class="sct_right">
							...
							<input type="hidden" name="page" value="edit_buildings"/> 
							...
							<input type="hidden" name="building_id" value="<?php echo $row->building_id?>" />
                                ...
                                <fieldset>
                                    ...
                                    <div class="row">
                                        <label>Name:</label>
                                        <div class="inputs">
                                            <span class="input_wrapper"><input class="text" type="text" id="building_name" name="building_name" value="<?php echo $row->building_name?>" size="50"/></span>
